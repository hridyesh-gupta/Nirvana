...
export default function RedWinesPage() {
  ...
  const swissRedWines = [
    {
      ...
      descriptionFr: 'Bernex, Genève 2021 (Nature rouge) – Arômes de fruits rouges, bouche souple et fraîche aux tanins fins.',
      image: '',
      variants: [
    ...
    },
    {
      ...
      descriptionFr: 'La Côte 2020 (Cuvée Jeune Prodige) – Vin fruité aux tanins souples, notes épicées, bouche douce et bien équilibrée.',
      image: '',
      variants: [
    ...
    },
    {
      ...
      descriptionFr: 'Satigny–Genève 2017 (Cuvée Matisse, Cabernet Sauvignon) – Arômes intenses de fruits noirs, notes d’épices et de réglisse. Vin structuré et persistant. Certifié biologique.',
      image: '',
      variants: [
    ...
    },
    {
      ...
      descriptionFr: '2022 – Vin rouge fruité, frais, aux tanins souples.',
      price: 65.00,
      image: ''
    },
    {
      ...
      descriptionFr: '2023 – Pinot noir léger, fruité et élégant aux tanins fins.',
      price: 59.00,
      image: ''
    },
    {
      ...
      descriptionFr: 'Vin rouge profond et structuré, intense et élégant.',
      price: 65.00,
      image: ''
    },
    {
      ...
      descriptionFr: 'Assemblage de cépages rouges, riche et complexe avec une grande profondeur aromatique.',
      price: 79.00,
      image: ''
    }
  ];
  ...
  const frenchRedWines = [
    {
      ...
      descriptionFr: '2018 – Vin bien équilibré aux tanins souples et au caractère élégant.',
      price: 85.00,
      image: ''
    },
    {
      ...
      descriptionFr: '2020 – Produit par le Domaine de l’Hortus au cœur du Pic Saint-Loup (Languedoc). Vin aux arômes de fruits rouges bien mûrs, cassis et mûre, avec une touche délicate d’épices et de garrigue. Parfaitement équilibré, aux tanins souples et à la finale persistante.',
      price: 95.00,
      image: ''
    },
    {
      ...
      descriptionFr: '2021 – Vin généreux et harmonieux doté d’une grande complexité aromatique.',
      price: 129.00,
      image: ''
    },
    {
      ...
      descriptionFr: '2023 – IGP Cité de Carcassonne. Assemblage de Grenache et Syrah, expressif et fruité, aux tanins fins, offrant un équilibre parfait entre puissance et fraîcheur.',
      price: 55.00,
      image: ''
    },
    {
      ...
      descriptionFr: '2023 (bio) – Issu d’un domaine familial certifié biologique. Vin aux arômes de fruits mûrs et d’épices, doté d’une structure fraîche et élégante.',
      price: 59.00,
      image: ''
    },
    {
      ...
      descriptionFr: '2019 (bio) – Pinot noir élégant aux arômes de petits fruits rouges et aux tanins subtils. Vin frais, vif et équilibré.',
      price: 65.00,
      image: ''
    }
  ];
  ...
  const worldRedWines = [
    ...
    },
    {
      ...
      descriptionFr: 'Valle de Uco, Mendoza 2019/18 – Argentine.',
      price: 59.00,
      image: ''
    },
    {
      ...
      descriptionFr: 'Valle de Colchagua D.O. 2018 – Chili.',
      price: 65.00,
      image: ''
    },
    {
      ...
      descriptionFr: '2019 conversion bio – Inde.',
      price: 49.00,
      image: ''
    }
  ];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-5xl md:text-6xl font-light mb-6 text-primary font-['fairdisplay']">
                {language === 'fr' ? 'Vins rouges' : 'Red Wines'}
              </h1>
              <div className="w-32 h-1 mx-auto rounded-full bg-gradient-to-r from-primary to-secondary" />
              <p className="text-lg text-gray-600 mt-6 max-w-3xl mx-auto">
                {language === 'fr'
                  ? 'Découvrez notre sélection exceptionnelle de vins rouges du monde entier, soigneusement choisis pour accompagner à merveille notre cuisine indienne.'
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                <h2 className="text-3xl text-primary font-semibold text-gray-800 mb-4">
                  {language === 'fr' ? 'Vins rouges suisses' : 'Swiss Red Wines'}
                </h2>
              </div>
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                <h2 className="text-3xl text-primary font-semibold text-gray-800 mb-4">
                  {language === 'fr' ? 'Vins rouges français' : 'French Red Wines'}
                </h2>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                <h2 className="text-3xl text-primary font-semibold text-gray-800 mb-4">
                  {language === 'fr' ? 'Vins rouges du monde' : 'World Red Wines'}
                </h2>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-primary">
                    {language === 'fr' ? 'Rouges légers à moyens' : 'Light to Medium Reds'}
                  </h3>
                  <p className="text-gray-600 mb-4">
                    {language === 'fr'
                      ? 'Les Beaujolais et les Bourgognes plus légers s’accordent parfaitement avec nos plats tandoori, nos préparations tikka et nos currys végétariens. Leur acidité fraîche complète idéalement les épices.'
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-primary">
                    {language === 'fr' ? 'Rouges charpentés' : 'Full-Bodied Reds'}
                  </h3>
                  <p className="text-gray-600 mb-4">
                    {language === 'fr'
                      ? 'Les assemblages bordelais et les vins de la vallée du Rhône accompagnent à merveille nos spécialités d’agneau, nos currys riches et nos préparations de bœuf maturé. Leurs tanins équilibrent la richesse de nos sauces.'
