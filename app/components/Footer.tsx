      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
          ...
          <div className="col-span-2 md:col-span-1 space-y-6"> {/* Contact Info - spans 2 columns on mobile, 1 on md+ */}
            <h4 className="text-xl font-semibold text-white mb-4">{t('footer.contactInfo')}</h4>
          ...
          <div className="space-y-6">
            <h4 className="text-xl font-semibold text-white mb-4">{t('footer.quickLinks')}</h4>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 text-center">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-6 text-sm text-white-400">
              <span>{language === 'fr' ? 'Développé et maintenu avec ❤️ par' : 'Developed and maintained with ❤️ by'} <strong><a href="https://ai.hridx.tech/" className="text-secondary underline underline-offset-4">HridxAI</a></strong>...</span>
            </div>
            <p className="text-gray-400 text-sm">
              {t('footer.allRights')}
            </p>
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <Link href="/privacy-policy" className="hover:text-secondary transition-colors cursor-pointer">{t('footer.privacyPolicy')}</Link>
              <Link href="/legal-notices" className="hover:text-secondary transition-colors cursor-pointer">{t('footer.legalNotices')}</Link>
            </div>
          </div>
        </div>
      </div>
