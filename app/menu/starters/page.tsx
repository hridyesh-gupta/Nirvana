...
export default function StartersPage() {
  ...
  const vegetarianStarters = [
    { id: 'veggie-soup', 
      ...
      descriptionFr: 'Soupe de légumes',
      image:'' },
    {
      id: 'daal-soup',
      name: 'Daal Soup',
    ...
    },
    {
      ...
      descriptionFr: 'Pois verts, pommes de terre et chapelure frits',
    ...
    },
    {
      ...
      descriptionFr: 'Farci de pommes de terre, feuilles de curry et herbes',
    ...
    },
    {
      ...
      descriptionFr: 'Yaourt, concombres, coriandre fraîche, épices',
    ...
    },
    {
      ...
      descriptionFr: 'Aubergines fumées au tandoor avec yaourt, herbes et épices',
    ...
    },
    {
      ...
      descriptionFr: 'Fromage indien mariné, grillé au tandoor',
    ...
    },
    {
      ...
      descriptionFr: 'Onion Bhaji, Samosa, Matar Tikki, Paneer Tikka',
      image: '',
      variants: [
  ...
  const tandooriGrills = [
    {
      ...
      descriptionFr: 'Poulet mariné grillé au tandoor',
    ...
    },
    {
      ...
      descriptionFr: 'Blanc de poulet mariné au poivre noir et grillé',
    ...
    },
    {
      ...
      descriptionFr: 'Kebab d’agneau haché',
    ...
    },
    {
      ...
      descriptionFr: 'Filets de dorade ou de bar marinés aux herbes de saison et aux saveurs épicées',
    ...
    },
    {
      ...
      descriptionFr: 'Grosses crevettes marinées et grillées aux saveurs épicées (décortiquées)',
    ...
    },
    {
      ...
      descriptionFr: 'Comprend samosa, Matar Tikki, Seekh Kebab et Black Pepper Chicken Tikka',
    ...
    },
    {
      ...
      descriptionFr: 'Comprend Seekh Kebab, Black Pepper Chicken Tikka, Prawns Tandoori et Paneer Tikka',
    ...
    { id: 'chicken-soup', 
      ...
      descriptionFr: 'Soupe de poulet parfaitement assaisonnée',
      image:'' },
  ];
  ...
  const saladsChoice = [
    {
      ...
      descriptionFr: 'Gambas et crevettes grillées, marinées aux épices',
    ...
    },
    {
      ...
      descriptionFr: 'Dorade ou bar mariné et grillé, servi avec une salade fraîche',
      image: '',
      // While uncommenting also include comma after image line
      // variants: [
    ...
    },
    {
      ...
      descriptionFr: 'Poulet tikka grillé, mariné aux noix de cajou et au poivre noir',
    ...
    },
    {
      ...
      descriptionFr: 'Fromage indien mariné et grillé',
    ...
    },
    {
      ...
      descriptionFr: 'Préparée avec concombre, piment vert, oignons et tomates',
      image: '',
      // While uncommenting also include comma after image line
      // variants: [
      //   { label: 'Starter', price: 10.00 },
        ...
        <div className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-secondary/30">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                <h2 className="text-3xl text-primary font-semibold text-gray-800 mb-4">
                  {language === 'fr' ? 'Entrées végétariennes' : 'Vegetarian Starters'}
                </h2>
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                <h2 className="text-3xl text-primary font-semibold text-gray-800 mb-4">
                  {language === 'fr' ? 'Grillades tandoori' : 'Tandoori Grills'}
                </h2>
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                <h2 className="text-3xl text-primary font-semibold text-gray-800 mb-4">
                  {language === 'fr' ? 'Salades & grillades au choix' : 'Salads & Grills of Choice'}
                </h2>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
